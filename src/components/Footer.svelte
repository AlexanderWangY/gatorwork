		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-4">
			...
			<div class="space-y-4">
				<div class="flex flex-row items-center gap-2">
					<img src="/Logo.svg" alt="Gator Market Logo" class="h-8" />
					<h3 class="text-lg font-semibold" style="color: #FF894A;">GatorMarket</h3>
				</div>
				<p class="text-brand-white text-sm">
					Your one-stop shop for buying and selling second-hand items from verified University of
					Florida students.
				</p>
			</div>
			...
			<!-- Quick Links -->
			<div class="space-y-4">
				<h3 class="text-brand-orange text-lg font-semibold">Quick Links</h3>
				<ul class="space-y-2">
					{#each footerLinks as link (link.name)}
						<li>
							<a href={link.url} style="color: #FFFBFA; transition: color 0.2s;" class="text-sm">
								{link.name}
							</a>
						</li>
					{/each}
			...
			<!-- Contact Info -->
			<div class="space-y-4">
				<h3 class="text-brand-orange text-lg font-semibold">Contact Us</h3>
				<div class="flex flex-col gap-1 space-y-2 text-sm">
					<a
						class="underline-offset-4 hover:underline"
						href="mailto:contact@getrewala.com"
						target="_blank">contact@getrewala.com</a
					>
					<p>+1 (314) 952 6281</p>
				</div>
			</div>
				...
				<div class="flex flex-col items-center justify-between md:flex-row">
					...
					<div class="mt-4 flex space-x-6 md:mt-0">
						{#each socialLinks as social (social.name)}
							<a
								href={social.url}
								class="text-brand-gray hover:text-brand-white"
